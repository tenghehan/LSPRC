...
from data.AttrDataset import AttrDataset, get_transform, get_transform_cocnn
from torch.utils.data import DataLoader
from config import argument_parser, argument_cocnn_parser
from models.CoCNN import CoCNN_ResNet50_Combine, CoCNN_ResNet50_Max
...
def main():
    ...
    train_transform, valid_transform = get_transform_cocnn(args)
